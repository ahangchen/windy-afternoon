...
goog.writeScriptSrcNode_(a);else c.write('<script type="text/javascript">'+b+"\x3c/script>");return!0}return!1},goog.needsTranspile_=function(a){if("always"==goog.TRANSPILE)return!0;if("never"==goog.TRANSPILE)return!1;goog.requiresTranspilation_||(goog.requiresTranspilation_=goog.createRequiresTranspilation_());if(a in goog.requiresTranspilation_)return goog.requiresTranspilation_[a];throw Error("Unknown language mode: "+a);},goog.createRequiresTranspilation_=function(){function a(a,b){d?c[a]=!0:
b()?c[a]=!1:d=c[a]=!0}function b(a){try{return!!eval(a)}catch(f){return!1}}var c={es3:!1},d=!1;a("es5",function(){return b("[1,].length==1")});a("es6",function(){return b('(()=>{"use strict";class X{constructor(){if(new.target!=String)throw 1;this.x=42}}let q=Reflect.construct(X,[],String);if(q.x!=42||!(q instanceof String))throw 1;for(const a of[2,3]){if(a==2)continue;function f(z={a}){let a=0;return z.a}{function f(){return 0;}}return f()==3}})()')});a("es6-impl",function(){return!0});a("es7",function(){return b("2 ** 2 == 4")});
a("es8",function(){return b("async () => 1, true")});return c},goog.requiresTranspilation_=null,goog.lastNonModuleScriptIndex_=0,goog.onScriptLoad_=function(a,b){"complete"==a.readyState&&goog.lastNonModuleScriptIndex_==b&&goog.loadQueuedModules_();return!0},goog.writeScripts_=function(a){function b(a){if(!(a in e.written||a in e.visited)){e.visited[a]=!0;if(a in e.requires)for(var f in e.requires[a])if(!goog.isProvided_(f))if(f in e.nameToPath)b(e.nameToPath[f]);else throw Error("Undefined nameToPath for "+
...
goog.defineClass.applyProperties_=function(a,b){for(var c in b)Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c]);for(var d=0;d<goog.defineClass.OBJECT_PROTOTYPE_FIELDS_.length;d++)c=goog.defineClass.OBJECT_PROTOTYPE_FIELDS_[d],Object.prototype.hasOwnProperty.call(b,c)&&(a[c]=b[c])};goog.tagUnsealableClass=function(a){!COMPILED&&goog.defineClass.SEAL_CLASS_INSTANCES&&(a.prototype[goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_]=!0)};goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_="goog_defineClass_legacy_unsealable";var sre={SystemExternal:function(){}};sre.SystemExternal.require=function(a){return"undefined"!==typeof require?require(a):null};sre.SystemExternal.documentSupported=function(){return"undefined"!=typeof document};sre.SystemExternal.process=sre.SystemExternal.require("process");sre.SystemExternal.xmldom=sre.SystemExternal.documentSupported()?window:sre.SystemExternal.require("xmldom");
...
sre.BrowserUtil.loadMapsForIE_=function(){sre.BrowserUtil.loadScript(sre.SystemExternal.jsonPath+"mathmaps_ie.js")};sre.BrowserUtil.loadScript=function(a){var b=sre.SystemExternal.document.createElement("script");b.type="text/javascript";b.src=a;sre.SystemExternal.document.head?sre.SystemExternal.document.head.appendChild(b):sre.SystemExternal.document.body.appendChild(b)};sre.Engine=function(){this.alternativeHost=this.activeHost=null;this.axisValues=sre.Engine.makeAxisValueObject_();this.evaluator=sre.Engine.defaultEvaluator;this.comparator=this.dynamicCstr=null;this.allDomains=[];this.allStyles=[];this.domain="default";this.style="short";this.walker="Syntax";this.semantics=!1;this.mode=sre.Engine.Mode.SYNC;this.speech=sre.Engine.Speech.NONE;this.ruleSets=[];this.cache=!0;this.isEdge=this.isIE=this.strict=this.ssml=!1;this.setupTests_=[]};goog.addSingletonGetter(sre.Engine);
sre.Engine.personalityProps={PITCH:"pitch",RATE:"rate",VOLUME:"volume",PAUSE:"pause"};sre.Engine.Mode={SYNC:"sync",ASYNC:"async",HTTP:"http"};sre.Engine.Speech={NONE:"none",SHALLOW:"shallow",DEEP:"deep"};sre.Engine.Axis={DOMAIN:"domain",STYLE:"style",LANGUAGE:"language",TOPIC:"topic",MODALITY:"modality"};sre.Engine.registerTest=function(a){sre.Engine.getInstance().setupTests_.push(a)};sre.Engine.isReady=function(){return sre.Engine.getInstance().setupTests_.every(function(a){return a()})};
sre.Engine.prototype.setupBrowsers=function(){this.isIE=sre.BrowserUtil.detectIE();this.isEdge=sre.BrowserUtil.detectEdge()};sre.Engine.makeAxisValueObject_=function(){var a={},b;for(b in sre.Engine.Axis)a[sre.Engine.Axis[b]]={};return a};sre.Engine.prototype.getAxisValues=function(){var a={},b;for(b in this.axisValues)a[b]=Object.keys(this.axisValues[b]);return a};sre.Engine.defaultEvaluator=function(a,b){return a};sre.BaseUtil={};sre.BaseUtil.removeEmpty=function(a){return a.filter(function(a){return a})};sre.BaseUtil.interleaveLists=function(a,b){for(var c=[];a.length||b.length;)a.length&&c.push(a.shift()),b.length&&c.push(b.shift());return c};sre.BaseUtil.setdifference=function(a,b){return a?b?a.filter(function(a){return 0>b.indexOf(a)}):a:[]};sre.BaseUtil.union=function(a,b){return a&&b?a.concat(sre.BaseUtil.setdifference(b,a)):a||b||[]};sre.BaseUtil.makePath=function(a){return a.match("/$")?a:a+"/"};sre.AuditoryDescription=function(a){this.context=a.context?a.context:"";this.text=a.text?a.text:"";this.userValue=a.userValue?a.userValue:"";this.annotation=a.annotation?a.annotation:"";this.correction=a.correction?a.correction:"";this.personality=a.personality;this.preprocess=!!a.preprocess};sre.AuditoryDescription.prototype.isEmpty=function(){return 0==this.context.length&&0==this.text.length&&0==this.userValue.length&&0==this.annotation.length};
sre.AuditoryDescription.prototype.clone=function(){var a;if(this.personality){a={};for(var b in this.personality)a=this.personality[b]}return new sre.AuditoryDescription({context:this.context,text:this.text,userValue:this.userValue,annotation:this.annotation,correction:this.correction,personality:a,preprocess:this.preprocess})};
...
sre.AuditoryDescription.preprocessString_=function(a){var b=sre.Engine.getInstance();return"mathspeak"==b.domain&&a.match(/^\d{1}$/)?a:b.evaluator(a,b.dynamicCstr)||a};sre.AuditoryDescription.processCorrections_=function(a,b){if(!b||!a)return a;var c=b.split(/ |-/),c=new RegExp("^"+c.join("( |-)")+"( |-)");return a.replace(c,"")};
sre.AuditoryDescription.preprocessDescription_=function(a){a.annotation&&(a.text+=":"+a.annotation,a.annotation="");a.preprocess&&(a.text=sre.AuditoryDescription.processCorrections_(sre.AuditoryDescription.preprocessString_(a.text),a.correction),a.preprocess=!1)};sre.AuditoryDescription.preprocessDescriptionList=function(a){for(var b=0,c;c=a[b];b++)sre.AuditoryDescription.preprocessDescription_(c)};sre.Debugger=function(){this.isActive_=!1;this.outputFunction_=console.log;this.stream_=null};goog.addSingletonGetter(sre.Debugger);sre.Debugger.prototype.init=function(a){a&&this.startDebugFile_(a);this.isActive_=!0};
...
sre.DomUtil.querySelectorAll=function(a,b){return a.querySelectorAll?sre.DomUtil.toArray(a.querySelectorAll(b)):sre.XpathUtil.evalXPath(".//"+b,a)};sre.DomUtil.tagName=function(a){return a.tagName.toUpperCase()};sre.DynamicCstr=function(a,b){this.components_=a;this.order_=b||Object.keys(a)};sre.DynamicCstr.prototype.getOrder=function(){return this.order_};sre.DynamicCstr.prototype.getComponents=function(){return this.components_};sre.DynamicCstr.prototype.getKeys=function(){return this.order_};sre.DynamicCstr.prototype.getValue=function(a){return this.components_[a]};sre.DynamicCstr.prototype.toString=function(){var a=[];this.order_.forEach(goog.bind(function(b){a.push(this.getValue(b))},this));return a.join(".")};
sre.DynamicCstr.prototype.equal=function(a){var b=a.getKeys();if(this.order_.length!==b.length)return!1;for(var c=0,d;d=b[c];c++){var e=this.getValue(d);if(!e||a.getValue(d)!==e)return!1}return!0};sre.DynamicCstr.create=function(a,b){var c={};c[sre.Engine.Axis.DOMAIN]=a;c[sre.Engine.Axis.STYLE]=b;return new sre.DynamicCstr(c)};sre.DynamicCstr.Parser=function(a){this.order_=a};
sre.DynamicCstr.Parser.prototype.parse=function(a){a=a.split(".");for(var b={},c=0,d;d=this.order_[c],a.length;c++){var e=a.shift();b[d]=e;sre.Engine.getInstance().axisValues[d][e]=!0}if(c<this.order_.length-1||a.length)throw Error("Invalid dynamic constraint: "+b);return new sre.DynamicCstr(b,this.order_)};sre.DynamicCstr.Comparator=function(){};sre.DynamicCstr.Comparator.prototype.getReference=function(){};sre.DynamicCstr.Comparator.prototype.setReference=function(a){};
sre.DynamicCstr.Comparator.prototype.match=function(a){};sre.DynamicCstr.Comparator.prototype.compare=function(a,b){};sre.DynamicCstr.DefaultComparator=function(a){this.reference_=a;this.order_=this.reference_.getOrder()};sre.DynamicCstr.DefaultComparator.prototype.getReference=function(){return this.reference_};sre.DynamicCstr.DefaultComparator.prototype.setReference=function(a){this.reference_=a;this.order_=this.reference_.getOrder()};
sre.DynamicCstr.DefaultComparator.prototype.match=function(a){var b=a.getKeys();return b.length===this.reference_.getKeys().length&&b.every(goog.bind(function(b){return a.getValue(b)==this.reference_.getValue(b)||"short"==a.getValue(b)||"default"==a.getValue(b)},this))};sre.DynamicCstr.DefaultComparator.prototype.compare=function(a,b){var c=this.countMatchingValues_(a),d=this.countMatchingValues_(b);return c>d?-1:d>c?1:0};
sre.DynamicCstr.DefaultComparator.prototype.countMatchingValues_=function(a){for(var b=0,c=0,d;d=this.order_[c];c++)if(this.reference_.getValue(d)===a.getValue(d))b++;else break;return b};sre.EnrichCase=function(){};sre.EnrichCase.prototype.getMathml=function(){};sre.AbstractEnrichCase=function(a){this.semantic=a};sre.AbstractEnrichCase.prototype.getMathml=goog.abstractMethod;sre.AbstractEnrichCase.test=goog.abstractMethod;sre.EnrichCaseFactory=function(){};sre.EnrichCaseFactory.getEmbellishedCase=function(a){return new sre.EnrichCaseFactory.embellishedCase(a)};sre.EnrichCaseFactory.cases=[];sre.EnrichCaseFactory.getCase=function(a){for(var b=0,c;c=sre.EnrichCaseFactory.cases[b];b++)if(c.test(a))return new c.constr(a);return null};sre.SemanticUtil=function(){};sre.SemanticUtil.objectsToKeys=function(a){a=Array.prototype.slice.call(arguments,0);var b=[];return b.concat.apply(b,a.map(Object.keys))};sre.SemanticUtil.objectsToValues=function(a){a=Array.prototype.slice.call(arguments,0);var b=[];a.forEach(function(a){for(var c in a)b.push(a[c])});return b};
...
sre.SemanticPred.isSimpleFunctionHead=function(a){return a.type===sre.SemanticAttr.Type.IDENTIFIER||a.role===sre.SemanticAttr.Role.LATINLETTER||a.role===sre.SemanticAttr.Role.GREEKLETTER||a.role===sre.SemanticAttr.Role.OTHERLETTER};sre.SemanticProcessor=function(){this.factory_=new sre.SemanticNodeFactory};goog.addSingletonGetter(sre.SemanticProcessor);sre.SemanticProcessor.prototype.setNodeFactory=function(a){this.factory_=a};
...
sre.SemanticProcessor.prototype.infixNode_=function(a,b){var c=sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.INFIXOP,a,[b],sre.SemanticProcessor.getEmbellishedInner_(b).textContent);c.role=b.role;return c};
...
sre.SemanticProcessor.prototype.prefixNode_=function(a,b){for(var c=sre.SemanticProcessor.partitionNodes_(b,sre.SemanticPred.isAttribute("role","SUBTRACTION")),d=sre.SemanticProcessor.getInstance().concatNode_(a,c.comp.pop(),sre.SemanticAttr.Type.PREFIXOP);0<c.rel.length;)d=sre.SemanticProcessor.getInstance().concatNode_(d,[c.rel.pop()],sre.SemanticAttr.Type.PREFIXOP),d.role=sre.SemanticAttr.Role.NEGATIVE,d=sre.SemanticProcessor.getInstance().concatNode_(d,c.comp.pop(),sre.SemanticAttr.Type.PREFIXOP);
return d};sre.SemanticProcessor.prototype.postfixNode_=function(a,b){return b.length?sre.SemanticProcessor.getInstance().concatNode_(a,b,sre.SemanticAttr.Type.POSTFIXOP):a};sre.SemanticProcessor.prototype.text=function(a,b,c){a=sre.SemanticProcessor.getInstance().factory_.makeLeafNode(a,b);a.type=sre.SemanticAttr.Type.TEXT;"MS"===c&&(a.role=sre.SemanticAttr.Role.STRING);sre.SemanticProcessor.exprFont_(a);return a};
...
sre.SemanticProcessor.prototype.getPunctuationInRow_=function(a){var b=sre.SemanticProcessor.partitionNodes_(a,function(a){return sre.SemanticPred.isPunctuation(a)&&!sre.SemanticPred.isAttribute("role","ELLIPSIS")(a)});if(0===b.rel.length)return a;a=[];var c=b.comp.shift();0<c.length&&a.push(sre.SemanticProcessor.getInstance().row(c));for(var d=0;0<b.comp.length;)a.push(b.rel[d++]),c=b.comp.shift(),0<c.length&&a.push(sre.SemanticProcessor.getInstance().row(c));return[sre.SemanticProcessor.getInstance().punctuatedNode_(a,
b.rel)]};
sre.SemanticProcessor.prototype.punctuatedNode_=function(a,b){var c=sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.PUNCTUATED,a,b);if(b.length===a.length){var d=b[0].role;if(d!==sre.SemanticAttr.Role.UNKNOWN&&b.every(function(a){return a.role===d}))return c.role=d,c}1===b.length&&a[0].type===sre.SemanticAttr.Type.PUNCTUATION?c.role=sre.SemanticAttr.Role.STARTPUNCT:1===b.length&&a[a.length-1].type===sre.SemanticAttr.Type.PUNCTUATION?c.role=sre.SemanticAttr.Role.ENDPUNCT:b.every(sre.SemanticPred.isAttribute("role",
...
[]),e.role=c.role,b=[e,b[1]],d=sre.SemanticAttr.Type.UNDERSCORE):(e=sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.UNDERSCORE,[c,b[1]],[]),e.role=sre.SemanticAttr.Role.UNDEROVER,b=[e,b[2]],d=sre.SemanticAttr.Type.OVERSCORE)}d=sre.SemanticProcessor.getInstance().factory_.makeBranchNode(d,b,[]);var f=sre.SemanticPred.isEmbellished(c);e&&(e.embellished=f);d.embellished=f;d.role=c.role;return d};
...
sre.SemanticMathml.prototype.tableRow_=function(a,b){var c=this.getFactory().makeBranchNode(sre.SemanticAttr.Type.ROW,this.parseNodes_(b),[]);c.role=sre.SemanticAttr.Role.TABLE;return c};sre.SemanticMathml.prototype.tableCell_=function(a,b){var c=this.parseNodes_(sre.SemanticUtil.purgeNodes(b)),c=this.getFactory().makeBranchNode(sre.SemanticAttr.Type.CELL,[sre.SemanticProcessor.getInstance().row(c)],[]);c.role=sre.SemanticAttr.Role.TABLE;return c};
sre.SemanticMathml.prototype.text_=function(a,b){return sre.SemanticProcessor.getInstance().text(a.textContent,a.getAttribute("mathvariant"),sre.DomUtil.tagName(a))};sre.SemanticMathml.prototype.identifier_=function(a,b){return sre.SemanticProcessor.getInstance().identifierNode(a.textContent,a.getAttribute("mathvariant"),a.getAttribute("class"))};sre.SemanticMathml.prototype.number_=function(a,b){var c=this.leaf_(a);sre.SemanticProcessor.number(c);return c};
...
b);for(var d=[],e=0,f=0,g,h;g=c[e],h=b[f];e++)g.getAttribute(sre.EnrichMathml.Attribute.ID)==h.getAttribute(sre.EnrichMathml.Attribute.ID)&&(f++,d.push(g));sre.EnrichMathml.setOperatorAttribute_(a,d);return c;case sre.Semantic.Type.APPL:return[c[0],b[0],c[1]];case sre.Semantic.Type.ROOT:return[c[1],c[0]];default:return c}};
...
sre.CaseBinomial.prototype.getMathml=function(){if(!this.semantic.childNodes.length)return this.mml;this.mml=sre.EnrichMathml.walkTree(this.semantic.childNodes[0]);if(this.mml.hasAttribute(sre.EnrichMathml.Attribute.TYPE)){var a=sre.DomUtil.createElement("mrow");a.setAttribute(sre.EnrichMathml.Attribute.ADDED,"true");sre.DomUtil.replaceNode(this.mml,a);a.appendChild(this.mml);this.mml=a}sre.EnrichMathml.setAttributes(this.mml,this.semantic);return this.mml};sre.CaseDoubleScript=function(a){sre.AbstractEnrichCase.call(this,a);this.mml=a.mathmlTree};goog.inherits(sre.CaseDoubleScript,sre.AbstractEnrichCase);sre.CaseDoubleScript.test=function(a){if(!a.mathmlTree)return!1;var b=sre.DomUtil.tagName(a.mathmlTree);return"MSUBSUP"===b&&a.type===sre.SemanticAttr.Type.SUPERSCRIPT||"MUNDEROVER"===b&&a.type===sre.SemanticAttr.Type.OVERSCORE};
...
this.collapsedChildren_(c),a;a.type===sre.SemanticAttr.Role.UNDEROVER&&(d=this.createNode(c[1][0]),d.type=sre.SemanticAttr.Type.UNDERSCORE,d.role=sre.SemanticAttr.Role.UNDEROVER,a.type=sre.SemanticAttr.Type.OVERSCORE,d.embellished=a.embellished,d.fencePointer=a.fencePointer,this.collapsedChildren_(c));return a};sre.RebuildStree.prototype.createNode=function(a){var b=new sre.SemanticNode(a);return this.nodeDict[a.toString()]=b};
...
sre.MathCompoundStore.prototype.addUnitRules=function(a){var b=a.names;b&&(a.names=b.map(function(a){return a+":unit"}));this.addFunctionRules(a)};sre.MathCompoundStore.prototype.lookupRule=function(a,b){var c=this.subStores_[a.textContent];return c?(b=b||c.parser.parse("default.default"),c.lookupRule(a,b)):null};
sre.MathCompoundStore.prototype.lookupString=function(a,b){var c=sre.XpathUtil.currentDocument?sre.XpathUtil.currentDocument.createTextNode(a):sre.DomUtil.createTextNode(a);return(c=this.lookupRule(c,b))?c.action.components.map(function(a){return a.content.slice(1,-1)}).join(" "):""};sre.MathSimpleStore.parseUnicode_=function(a){a=parseInt(a,16);if(65536>a)return String.fromCharCode(a);a-=65536;return String.fromCharCode((a>>10)+55296,(a&1023)+56320)};sre.MathMap=function(){this.store=sre.MathCompoundStore.getInstance();this.retrieveMaps()};goog.addSingletonGetter(sre.MathMap);sre.MathMap.toFetch_=0;sre.Engine.registerTest(function(){return sre.MathMap.getInstance()&&!sre.MathMap.toFetch_});sre.MathMap.prototype.stringify=function(){return JSON.stringify(this)};sre.MathMap.SYMBOLS_PATH_="symbols";sre.MathMap.FUNCTIONS_PATH_="functions";sre.MathMap.UNITS_PATH_="units";sre.MathMap.SYMBOLS_FILES_="greek-capital.json greek-small.json greek-scripts.json greek-mathfonts.json greek-symbols.json hebrew_letters.json latin-lower-double-accent.json latin-lower-normal.json latin-lower-phonetic.json latin-lower-single-accent.json latin-rest.json latin-upper-double-accent.json latin-upper-normal.json latin-upper-single-accent.json latin-mathfonts.json math_angles.json math_arrows.json math_characters.json math_delimiters.json math_digits.json math_geometry.json math_harpoons.json math_non_characters.json math_symbols.json math_whitespace.json other_stars.json".split(" ");
...
'self::span[@class="msubsup"]','./*[1]/*[2]/*[1]=./*[1]/*[2]/span[@class="mrow"]',"count(./*[1]/*[2]/*[1]/*)=1","./*[1]/*[2]/*[1]/*[1][text()=3]")};sre.MathmlStoreRules.getInstance().initializer=[sre.MathmlStoreRules.initCustomFunctions_,sre.MathmlStoreRules.initDefaultRules_,sre.MathmlStoreRules.initMathjaxRules_,sre.MathmlStoreRules.initAliases_,sre.MathmlStoreRules.initSpecializationRules_];sre.MathspeakUtil={};sre.MathspeakUtil.spaceoutText=function(a){return a.textContent.split("").join(" ")};sre.MathspeakUtil.spaceoutNumber=function(a){a=a.textContent.split("");for(var b=[],c=new sre.SystemExternal.xmldom.DOMParser,d=0,e;e=a[d];d++){var f=sre.Semantic.Type.NUMBER,g=e.match(/\W/)?sre.Semantic.Role.UNKNOWN:sre.Semantic.Role.PROTECTED;e=c.parseFromString("<"+f+' role="'+g+'">'+e+"</"+f+">","text/xml");b.push(e.documentElement)}return b};
...
"children/*[2][text()=3]",'name(./children/*[1])!="text"');(0,sre.SemanticTreeRules.defineRule_)("root","default.default",'[t] "root of order"; [n] children/*[1];[t] "over"; [n] children/*[1] (rate:0.2); [p] (pause:400)',"self::root");(0,sre.SemanticTreeRules.defineRule_)("text","default.default","[n] text(); [p] (pause:200)","self::text");(0,sre.SemanticTreeRules.defineRule_)("unit","default.default","[t] text() (annotation:unit, preprocess)","self::identifier",'@role="unit"');(0,sre.SemanticTreeRules.defineRule_)("unit-square",
"default.default",'[t] "square"; [n] children/*[1]',"self::superscript",'@role="unit"',"children/*[2][text()=2]",'name(children/*[1])="identifier"');(0,sre.SemanticTreeRules.defineRule_)("unit-cubic","default.default",'[t] "cubic"; [n] children/*[1]',"self::superscript",'@role="unit"',"children/*[2][text()=3]",'name(children/*[1])="identifier"');(0,sre.SemanticTreeRules.defineRule_)("reciprocal","default.default",'[t] "reciprocal"; [n] children/*[1]',"self::superscript",'@role="unit"','name(children/*[1])="identifier"',
'name(children/*[2])="prefixop"','children/*[2][@role="negative"]',"children/*[2]/children/*[1][text()=1]",'count(preceding-sibling::*)=0 or preceding-sibling::*[@role!="unit"]');(0,sre.SemanticTreeRules.defineRule_)("reciprocal","default.default",'[t] "per"; [n] children/*[1]',"self::superscript",'@role="unit"','name(children/*[1])="identifier"','name(children/*[2])="prefixop"','children/*[2][@role="negative"]',"children/*[2]/children/*[1][text()=1]",'preceding-sibling::*[@role="unit"]');(0,sre.SemanticTreeRules.defineRule_)("unit-combine",
"default.default","[m] children/*","self::infixop",'@role="unit"');(0,sre.SemanticTreeRules.defineRule_)("unit-divide","default.default",'[n] children/*[1] (pitch:0.3); [t] "per"; [n] children/*[2] (pitch:-0.3)',"self::fraction",'@role="unit"')};sre.SemanticTreeRules.getInstance().initializer=[sre.SemanticTreeRules.initCustomFunctions_,sre.SemanticTreeRules.initSemanticRules_];sre.SpeechRuleStores={};sre.SpeechRuleStores.RULE_SETS_={MathmlStoreRules:sre.MathmlStoreRules,SemanticTreeRules:sre.SemanticTreeRules,MathspeakRules:sre.MathspeakRules,ClearspeakRules:sre.ClearspeakRules,AbstractionRules:sre.AbstractionRules,PrefixRules:sre.PrefixRules};sre.SpeechRuleStores.availableSets=function(){return Object.keys(sre.SpeechRuleStores.RULE_SETS_)};sre.SpeechRuleStores.getConstructor=function(a){return(a=sre.SpeechRuleStores.RULE_SETS_[a])?a:null};sre.SpeechRuleEngine=function(){this.activeStore_=null;this.globalParameters_={};this.cache_={}};goog.addSingletonGetter(sre.SpeechRuleEngine);sre.SpeechRuleEngine.prototype.setGlobalParameter=function(a,b){this.globalParameters_[a]=b};sre.SpeechRuleEngine.prototype.getGlobalParameter=function(a){return this.globalParameters_[a]};sre.SpeechRuleEngine.prototype.parameterize=function(a){for(var b=[],c=0,d=a.length;c<d;c++){var e=sre.SpeechRuleStores.getConstructor(a[c]);e&&e.getInstance&&b.push(e.getInstance())}this.parameterize_(b)};
...
sre.SpeechRuleEngine.prototype.evaluateTree_=function(a){var b=sre.Engine.getInstance();if(b.cache){var c=this.getCacheForNode_(a);if(c)return c}var c=b.dynamicCstr||this.activeStore_.parser.parse("default.default"),d=this.activeStore_.lookupRule(a,c);if(!d){if(b.strict)return[];c=this.activeStore_.evaluateDefault(a);this.pushCache_(a,c);return c}sre.Debugger.getInstance().generateOutput(goog.bind(function(){return[d.name,d.dynamicCstr.toString(),a.toString()]},this));for(var b=d.action.components,
c=[],e=0,f;f=b[e];e++){var g=[],h=f.content||"";switch(f.type){case sre.SpeechRule.Type.NODE:(h=this.activeStore_.applyQuery(a,h))&&(g=this.evaluateTree_(h));break;case sre.SpeechRule.Type.MULTI:h=this.activeStore_.applySelector(a,h);0<h.length&&(g=this.evaluateNodeList_(h,f.sepFunc,this.constructString(a,f.separator),f.ctxtFunc,this.constructString(a,f.context)));break;case sre.SpeechRule.Type.TEXT:(h=this.constructString(a,h))&&(g=[new sre.AuditoryDescription({text:h})]);break;default:g=[new sre.AuditoryDescription({text:h})]}g[0]&&
f.type!=sre.SpeechRule.Type.MULTI&&(f.context&&(g[0].context=this.constructString(a,f.context)+(g[0].context||"")),f.annotation&&(g[0].annotation=f.annotation),f.preprocess&&(g[0].preprocess=!0));c=c.concat(this.addPersonality_(g,f))}this.pushCache_(a,c);return c};
...
sre.SpeechRuleEngine.prototype.updateEngine=function(){var a=sre.MathMap.getInstance();if(sre.Engine.isReady()){var b=sre.Engine.getInstance();b.allDomains=Object.keys(b.axisValues[sre.Engine.Axis.DOMAIN]);b.allStyles=Object.keys(b.axisValues[sre.Engine.Axis.STYLE]);b.evaluator=goog.bind(a.store.lookupString,a.store)}else setTimeout(goog.bind(this.updateEngine,this),500)};sre.SpeechGeneratorUtil={};sre.SpeechGeneratorUtil.computeSpeech=function(a){var b=sre.SpeechRuleEngine.getInstance();b.clearCache();return b.evaluateNode(a)};sre.SpeechGeneratorUtil.recomputeSpeech=function(a,b){var c=sre.SemanticTree.fromNode(b);return sre.SpeechRuleEngine.getInstance().evaluateNode(c.xml())};
sre.SpeechGeneratorUtil.retrieveSpeech=function(a,b){var c=null;sre.Engine.getInstance().cache&&(c=sre.SpeechRuleEngine.getInstance().getCache(b.id.toString()));c||(c=sre.SpeechGeneratorUtil.recomputeSpeech(a,b));return sre.AuditoryDescription.speechString(c)};sre.SpeechGeneratorUtil.addSpeech=function(a,b){var c=sre.SpeechGeneratorUtil.retrieveSpeech(a,b);a.setAttribute(sre.EnrichMathml.Attribute.SPEECH,c)};
sre.SpeechGeneratorUtil.addPrefix=function(a,b){var c=sre.SpeechGeneratorUtil.retrievePrefix(b);c&&a.setAttribute(sre.EnrichMathml.Attribute.PREFIX,c)};sre.SpeechGeneratorUtil.retrievePrefix=function(a){a=sre.SpeechGeneratorUtil.computePrefix_(a);return sre.AuditoryDescription.speechString(a)};
...
sre.AbstractWalker.prototype.deactivate=function(){this.isActive()&&(this.highlighter.setState(this.node.id,this.primaryId()),this.generator.end(),this.toggleActive_())};sre.AbstractWalker.prototype.getFocus=function(){return this.focus_};sre.AbstractWalker.prototype.getDepth=function(){return this.levels.depth()-1};
...
sre.System.prototype.move=function(a){return sre.System.LocalStorage_.getInstance().walker?!1===sre.System.LocalStorage_.getInstance().walker.move(a)?null:sre.System.LocalStorage_.getInstance().walker.speech():null};sre.Api={};sre.Api.toSpeech=function(a){return sre.System.getInstance().toSpeech(a)};module.exports.processExpression=sre.Api.toSpeech;module.exports.toSpeech=sre.Api.toSpeech;module.exports.toSemantic=sre.System.getInstance().toSemantic;module.exports.toJson=sre.System.getInstance().toJson;module.exports.toDescription=sre.System.getInstance().toDescription;module.exports.toEnriched=sre.System.getInstance().toEnriched;module.exports.walk=sre.System.getInstance().walk;module.exports.move=sre.System.getInstance().move;
module.exports.file={};module.exports.file.toSpeech=sre.System.getInstance().fileToSpeech;module.exports.processFile=sre.System.getInstance().fileToSpeech;module.exports.file.toSemantic=sre.System.getInstance().fileToSemantic;module.exports.file.toJson=sre.System.getInstance().fileToJson;module.exports.file.toDescription=sre.System.getInstance().fileToDescription;module.exports.file.toEnriched=sre.System.getInstance().fileToEnriched;module.exports.setupEngine=sre.System.getInstance().setupEngine;
module.exports.pprintXML=sre.DomUtil.formatXml;module.exports.pprintXML=sre.DomUtil.formatXml;module.exports.engineReady=sre.Engine.isReady;sre.System.getInstance().setupEngine({mode:sre.Engine.Mode.ASYNC});
